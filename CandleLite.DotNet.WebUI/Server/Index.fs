module CandleLite.DotNet.WebUI.Server.Index
...
let page = doctypeHtml {
    head {
        ...
        link { attr.rel "stylesheet"; attr.href "prism/prism.css" }
        script { attr.src "prism/prism.js" }
        script { attr.src "prism/prism-web-component.js" }
        // script {
        //     attr.``type`` "text/javascript"
        //     rawHtml """
        //     window.highlightJSON = (code) => {
